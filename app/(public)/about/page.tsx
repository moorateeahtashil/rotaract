  ...
  return (
    <div>
      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-charcoal mb-4">Six Avenues of Service</h2>
            <p className="text-pewter max-w-2xl mx-auto">
              Rotaract focuses on six key areas of service that guide our activities and projects.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: "Club Service", desc: "Strengthening fellowship, ensuring effective club functioning, and planning social activities." },
              { name: "Community Service", desc: "Improving the quality of life in our community through service projects." },
              { name: "Vocational Service", desc: "Promoting integrity, recognizing worthy occupations, and building goodwill." },
              { name: "International Service", desc: "Expanding humanitarian efforts and promoting global understanding." },
              { name: "Professional Development", desc: "Building skills, knowledge, and networks for career advancement." },
              { name: "Environmental Sustainability", desc: "Protecting and preserving our natural resources and environment." },
            ].map((avenue) => (
              <div key={avenue.name} className="p-6 rounded-lg border border-border bg-white">
